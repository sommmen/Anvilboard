...
| 8 | [`artifacts.md`](./artifacts.md) ([implementation plan](../plans/artifacts.md)) | P1 | Partial — domain model and `IArtifactStore`/SQLite storage exist; the `ArtifactService` application layer, REST/CLI/MCP surfaces, and audit emission are planned (**CRIT-003**) | Issue & Board Service, Workspace Authorization | `FR-ART-001`, `FR-ART-002` |

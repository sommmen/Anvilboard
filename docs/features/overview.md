...
| 8 | [`artifacts.md`](./artifacts.md) ([implementation plan](../plans/artifacts.md)) | P1 | Implemented — `ArtifactService`, REST and agent surfaces, and audit emission are in place (**CRIT-003** resolved); still outstanding are the content-download endpoint, the Angular artifact panel, and the `GitHubPullRequestArtifactSync` plugin | Issue & Board Service, Workspace Authorization | `FR-ART-001`, `FR-ART-002` |
...
Feature specs were authored against the current
